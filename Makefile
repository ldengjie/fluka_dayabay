...
all:            libResults.so FluLib.o FarMuon
...
FarMuon:     $(OBJS) FluLib.$(ObjSuf) libResults.so
	       $(FLUPRO)/flutil/ldpmqmd -o $@ -m fluka $?


clean:
		@rm -f FarMuon Results.o ResultsDict.o FluLib.o core *.so ResultsDict.cpp $(OBJS) *.FOR
